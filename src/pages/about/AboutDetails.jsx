    ...
    <section className="py-20 bg-white flex flex-col md:flex-row items-center justify-between px-6 md:px-16 gap-10">
      ...
      <div className="flex-1 relative border-l-4 border-[#00A3FF] pl-6 hover:translate-x-2 transition-transform duration-500">
        ...
        <p className="text-gray-600 mb-8 leading-relaxed">
          ...
          breadth of global coverage, combined with specialist expertise, allows
          us to deliver world-class IT solutions to our clients.
        </p>
      ...
      <div className="flex-1 flex justify-center relative">
        <div className="relative transform hover:scale-105 transition-transform duration-700 w-full">
          <img
            src="/Images/novarsis-details.webp"
            alt="IT Services"
            className="rounded-lg shadow-2xl w-full md:w-full border-4 border-[#00A3FF]/20"
          />

          {/* Floating Box */}
          <div className="absolute bottom-4 right-4 bg-[#1a237e] text-white rounded-md shadow-xl px-6 py-3 flex items-center space-x-3 transform hover:scale-105 transition-transform duration-500">
